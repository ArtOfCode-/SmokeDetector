...
def api_get_post(post_url):
    ...
    request_url = "http://api.stackexchange.com/2.2/{type}s/{post_id}?site={site}&filter={api_filter}&key=lKfzuApO1ASY*NegoDzU0g((".format(type=post_type, post_id=post_id, site=site, api_filter=api_filter)
